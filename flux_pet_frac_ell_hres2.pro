FUNCTION FLUX_PET_ELL_HRES, rad, G, r_img
...
FUNCTION FLUX_PET_FRAC_ELL_HRES2, frac, rad, G
 ...
 flux_pet_t = flux_pet_ell_hres(1.5*rad2, G, r_img2) ; total flux with 1.5 petrosian rads 
