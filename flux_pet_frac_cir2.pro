...
if (r lt rad) then print, 'Galaxy bigger than image'

return, output

end
  
FUNCTION FLUX_PET_FRAC_CIR2, frac, rad, G
 ; calculates ratio of flux with ap to flux within 2 rpets 

 flux_pet_t = flux_pet_cir2(1.5*rad, G) ; total flux with 1.5 petrosian rads 
 frac_t = flux_pet_t[*,1]
 rad_t = flux_pet_t[*,0]
