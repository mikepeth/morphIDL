...
startchunk=1
get_gmorph_acs_v3,  13131, '/user/lotz/candels/cosmos/wfc3/cosmos_wfc3_f125w_60mas_badc.cat', $
...
'/user/lotz/candels/cosmos/wfc3/cos_wfc3_f125w_060mas_badc1.morph', $
big_xpix, big_ypix,im_psf,im_scale,zeropt,exptimefile, nchunk, startchunk


startchunk=2
get_gmorph_acs_v3,  0, '/user/lotz/candels/cosmos/wfc3/cosmos_wfc3_f125w_60mas_badc.cat', $
'/user/lotz/candels/cosmos/wfc3/cos_2epoch_wfc3_f125w_060mas_v1.0_drz.fits', $
'/user/lotz/candels/cosmos/wfc3/cos_2epoch_wfc3_f125w_060mas_v1.0_wht.fits', $
'/user/lotz/candels/cosmos/wfc3/cos2e_f160w_seg.fits', $
'/user/lotz/candels/cosmos/wfc3/cos_wfc3_f125w_060mas_badc2.morph', $
big_xpix, big_ypix,im_psf,im_scale,zeropt,exptimefile, nchunk, startchunk
