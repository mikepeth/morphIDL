PRO run_gmorph_ps1_nonmergers3
...
for img=400, Ngals[0]-1  do begin
...
;nids = size(ids,/dimensions)
   ...
   print, gband
   get_gmorph_manga, fullbasename+'_cold_primary_400x600.cat', $
                  ;galFiles[img], $
                gband+'g.fits', $
   				gband+'g.wt.fits', $
                fullbasename+'_cold_seg.fits', $
   	            fullbasename+'_gband_primary_400x600.morph', $
